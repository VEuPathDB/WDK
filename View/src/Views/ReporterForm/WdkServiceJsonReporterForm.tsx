...
import { getAttributeTree, getTableTree, getAttributeSelections, getAttributesChangeHandler, addPk } from 'Views/ReporterForm/reporterUtils';
...
import {State} from "Views/ReporterForm/DownloadFormStore";
