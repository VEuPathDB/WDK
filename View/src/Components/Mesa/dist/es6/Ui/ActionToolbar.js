...
var ActionToolbar = function (_React$PureComponent) {
  ...
  _createClass(ActionToolbar, [{
    ...
    value: function renderActionItemList(_ref2) {
      ...
      return !actions ? null : actions.filter(function (action) {
        return action.element;
      }).map(function (action) {
        return _react2.default.createElement(ActionItem, { action: action });
      });
    }
  }, {
    key: 'render',
...
ActionToolbar.propTypes = {
  ...
  eventHandlers: _propTypes2.default.array
};
