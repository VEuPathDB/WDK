...
<div class="attributesList formPopup" title="Select Columns">
  ...
  <div class="attributesFormWrapper">
    ...
    <c:if test="${wdkAnswer.useCheckboxTree}">
      ...
      <imp:checkboxTree id="${checkboxTreeId}" rootNode="${wdkAnswer.attributes.displayableAttributeTree}" checkboxName="selectedFields" showSelectAll="false" showResetCurrent="true" useHelp="true"/>
    </c:if>
