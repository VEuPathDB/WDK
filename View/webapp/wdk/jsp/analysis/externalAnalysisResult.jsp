...
<jsp:root version="2.0"
  ...
  <c:url var="propertiesUrl" value="${urlBase}/${applicationContext.wdkServiceEndpoint}/users/current/steps/${stepId}/analyses/${analysisId}/properties?accessToken=${accessToken}"/>
