...
(function(){function M(a,b){if(a&&"object"===typeof a&&a.constructor===this)return a;var c=new this(s,b);q(c,a);return c}function y(a,b,c){1===C.push({name:a,G:{K:b.q+b.r,J:a,detail:b.b,I:c&&b.q+c.r,label:b.u,timeStamp:N(),stack:Error(b.u).stack}})&&setTimeout(function(){for(var a,b=0;b<C.length;b++)a=C[b],h.l(a.name,a.G);C.length=0},50)}function O(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]===b)return c;return-1}function G(a){var b=a.v;b||(b=a.v={});return b}function P(a,b){if("onerror"===a)h.k("error",
...
b)},rethrow:function(a){setTimeout(function(){throw a;});throw a;},defer:function(a){var b={};b.promise=new l(function(a,d){b.resolve=a;b.reject=d},a);return b},EventTarget:Y,configure:P,async:function(a,b){h.async(a,b)}};"function"===typeof define&&define.amd?define(function(){return L}):"undefined"!==typeof module&&module.exports?module.exports=L:"undefined"!==typeof this&&(this.RSVP=L)}).call(this);
