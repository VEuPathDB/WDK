    ...
    return (
      <div className="wdk-DateRangeSelector">
        <div className="control-row">
          <label>From</label>
          <DateSelector start={start} end={end} value={value.min} onChange={this.handleMinValueChange} />
        </div>
        <div className="control-row">
          <label>To</label>
          <DateSelector start={start} end={end} value={value.max} onChange={this.handleMaxValueChange} />
        </div>
      </div>
    )
  }
