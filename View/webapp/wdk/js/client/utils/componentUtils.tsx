...
export function wrappable<P>(Component: any): ComponentWrapper<P> {
  return class Wrapper extends PureComponent<P, void> {
...
export function instrument<P>(Component: any, options: InstrumentOptions = {}) {
  let {
    compareProps = true
  } = options;
  let componentName = Component.displayName || Component.name || Component;

  return class InstrumentWrapper extends React.Component<P, void> {
