...
public class CheckLoginFilter implements Filter {
        ...
        try {
          ...
          switch (stateBundle.getCurrentState()) {
            case REGISTERED_USER_BAD_COOKIE:
              ...
              userToSet = createSavedGuest(wdkModel);
              break;
  ...
  private static User createSavedGuest(WdkModel wdkModel) {
    return wdkModel.getUserFactory().saveTemporaryUser(new GuestUser(wdkModel));
  }
