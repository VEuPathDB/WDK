...
WDK::Model::ModelProp - access to WDK model.prop

=head1 SYNOPSIS

    use WDK::Model::ModelProp;

    my $prop = new WDK::Model::ModelProp('TrichDB');
...
=head2 new
 ...
 Usage   : my $prop = new WDK::Model::ModelProp('TrichDB');
