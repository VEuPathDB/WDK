 ...
 * 
 */
public abstract class DynamicAttributeValueContainer implements AttributeValueContainer {

  private static final Logger logger = Logger.getLogger(DynamicAttributeValueContainer.class);
