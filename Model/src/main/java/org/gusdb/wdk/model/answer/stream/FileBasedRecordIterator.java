...
class FileBasedRecordIterator implements Iterator<RecordInstance> {
   ...
   * @throws WdkUserException
   */
  protected void attachTable(TableField tableField, Map<TableField,TwoTuple<Iterator<RecordInstance>,RecordInstance>>tableIteratorMap, DynamicRecordInstance aggregateRecordInstance) throws WdkModelException, WdkUserException {
   ...
   * @throws WdkUserException
   */
  protected TableValue createEmptyTableValue(TableField tableField, PrimaryKeyAttributeValue primaryKey) throws WdkModelException, WdkUserException {
