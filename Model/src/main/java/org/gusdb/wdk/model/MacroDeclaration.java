...
/**
 * An object representation of {@code <declaredMacro>}. it defines the scope of
 * the macros, that is, where the macro will be used, in the {@code model.prop}.
 * 
 * @author xingao
 * 
 */
public class MacroDeclaration extends WdkModelBase {
  ...
  public void setUsedBy(String usedBy) {
    ...
    for (String part : parts) {
      part = part.trim();
      if ("model".equalsIgnoreCase(part))
        usedByModel = true;
      else if ("jsp".equalsIgnoreCase(part))
        usedByJsp = true;
      else if ("perl".equalsIgnoreCase(part))
        usedByPerl = true;
    }
  }
