...
public class UserDatasetExternalDatasetEvent extends UserDatasetEvent {
  ...
  public UserDatasetExternalDatasetEvent(Integer eventId, Set<String> projectsFilter, Integer userDatasetId, UserDatasetType userDatasetType, Integer userId, ExternalDatasetAction action) {
