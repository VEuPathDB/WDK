...
public class Oracle extends DBPlatform {
  ...
  public int getNextId(String schema, String table) throws WdkModelException {
    ...
    BigDecimal id = (BigDecimal) SqlUtils.executeScalar(wdkModel, dataSource,
  ...
  public void disableStatistics(String schema, String tableName)
    ...
    try {
      ...
      connection.rollback();
      throw new WdkModelException("Unable to disable statistics on table "
          + schema + "." + tableName, e);
    } finally {
      try {
        stUnlock.close();
  ...
  public String[] queryTableNames(String schema, String pattern)
    ...
    try {
      ...
      throw new WdkModelException("Could not query table names from schema [ "
          + schema + " ]", e);
    } finally {
