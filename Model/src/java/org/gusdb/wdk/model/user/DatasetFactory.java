...
public class DatasetFactory {
    ...
    public Dataset getDataset(User user, int datasetId) throws WdkUserException {
        // check if the dataset exist, globally
    ...
    private Dataset putDatasetIndex(String[] values) throws WdkModelException,
        ...
        try {
            ...
            int datasetId = platform.getNextId(datasetSchema, "dataset_indices");
    ...
    private Dataset getDatasetIndex(int datasetId) throws WdkUserException {
        DataSource dataSource = platform.getDataSource();
        ResultSet rs = null;
        try {
            PreparedStatement ps = SqlUtils.getPreparedStatement(dataSource,
