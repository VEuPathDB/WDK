...
public class RecordTester {
    ...
    public static void main( String[ ] args ) {
        ...
        try {
            ...
            System.out.println("Model initialization took: " + ((System.currentTimeMillis()-st)/1000F) + " seconds.");
            ...
            System.out.println("Record creation took: " + ((System.currentTimeMillis()-st)/1000F) + " seconds.");
            st = System.currentTimeMillis();
            ...
            System.out.println("Fields retrieval took: " + ((System.currentTimeMillis()-st)/1000F) + " seconds.");
            ...
            System.out.println("Total time spent: " + ((end -start)/1000F) + " seconds.");
        }
    }
