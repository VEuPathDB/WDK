...
public class ModelXmlParser extends XmlParser {
	...
	private InputStream substituteProps(Document masterDoc,
		...
		for (String propName : properties.keySet()) {
			...
			content = content.replaceAll("\\@" + propName + "\\@", Matcher
					.quoteReplacement(propValue));
		}
	...
	private void configureParamSet(Digester digester) {
		...
		configureNode(digester, "wdkModel/paramSet/enumParam/help",
				WdkModelText.class, "addHelp");
		digester
				.addCallMethod("wdkModel/paramSet/enumParam/help", "setText", 0);
		...
		digester
				.addBeanPropertySetter("wdkModel/paramSet/enumParam/enumList/enumValue/display");
		digester
				.addBeanPropertySetter("wdkModel/paramSet/enumParam/enumList/enumValue/term");
		digester
				.addBeanPropertySetter("wdkModel/paramSet/enumParam/enumList/enumValue/internal");
	}
	...
	private void configureQuestionSet(Digester digester) {
		...
		configureNode(digester, "wdkModel/questionSet/description",
				WdkModelText.class, "addDescription");
		digester
				.addCallMethod("wdkModel/questionSet/description", "setText", 0);
