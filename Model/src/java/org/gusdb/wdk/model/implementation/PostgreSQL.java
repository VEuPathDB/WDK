...
/**
 * STEVE: To make wdk postgres compatible, you have to change
 * the number datatype into its appropriate platform instead
 * of assuming it will use 'number()'. I added two function below
 * to get the number datatype and varchar data type. ResultFactory
 * should also be change to use the method getNumberDataType()
 * and getVarcharDataType() instead of assuming 'number()'. Other
 * changes is the generation of database file for toy wdk to also
 * change the data type depending on the user's platform of choice.
...
public class PostgreSQL implements RDBMSPlatformI {
    ...
    /**
     * STEVE: I change it to use nextval() to get the next sequence
     */
    ...
    /**
     * STEVE: This should be part of RBMSPlatform interface
     * A function to get number type for this platform
     */
    public String getNumberDataType(int length) {
        return "integer";
    }
    
    /**
     * STEVE: Same here. Maybe having function to
     * generate null is also useful.
     */
