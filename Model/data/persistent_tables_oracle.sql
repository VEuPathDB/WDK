...
CREATE INDEX wdkuser.step_params_idx01 ON wdkuser.step_params (step_id, param_name);
...
CREATE INDEX wdkuser.user_datasets2_idx01 ON wdkuser.user_datasets2 (user_id);
