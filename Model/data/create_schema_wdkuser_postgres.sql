...
CREATE SCHEMA IF NOT EXISTS wdkuser AUTHORIZATION userdb_owner;
GRANT USAGE ON SCHEMA wdkuser TO wdkuser_r;
...
ALTER TABLE wdkuser.users OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.users TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.users TO wdkuser_w;
...
ALTER TABLE wdkuser.preferences OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.preferences TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.preferences TO wdkuser_w;
...
ALTER TABLE wdkuser.user_baskets OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.user_baskets TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.user_baskets TO wdkuser_w;
...
ALTER TABLE wdkuser.favorites OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.favorites TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.favorites TO wdkuser_w;
...
ALTER TABLE wdkuser.datasets OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.datasets TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.datasets TO wdkuser_w;
...
ALTER TABLE wdkuser.dataset_values OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.dataset_values TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.dataset_values TO wdkuser_w;
...
ALTER TABLE wdkuser.steps OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.steps TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.steps TO wdkuser_w;
...
ALTER TABLE wdkuser.strategies OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.strategies TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.strategies TO wdkuser_w;
...
ALTER TABLE wdkuser.step_analysis OWNER TO userdb_owner;
GRANT SELECT ON wdkuser.step_analysis TO wdkuser_r;
GRANT INSERT, UPDATE, DELETE ON wdkuser.step_analysis TO wdkuser_w;
