...
<table class="basket">
  <tr>
    ...
    <td>
      <input id="make-strategy-from-basket-button" type="button" value="Save as Strategy" onClick="window.location='<c:url value='/processQuestion.do?questionFullName=InternalQuestions.GeneRecordClasses_GeneRecordClassBySnapshotBasket&GeneRecordClasses_GeneRecordClassDataset_type=basket&questionSubmit=Run+Step'/>'"/>
    </td>
  </tr>
</table>
