 ...
 * 
 * This class is bascially a wrapper around the QueryInstance. This is a
 * useless class and should be refactored into QueryInstance when the chance
 * arises.
 */
...
public class ResultFactory implements Serializable {
    ...
    /**
     * Depending on persistence of the QueryInstance this method will
     * return the result of the query in an NonPersistent ResultList or
     * a PersistentResultList which works over an Database table.
     * <br/><br/>
     * (note: This class is utterly useless this should be refactored into
     * QueryInstance. The synchronization is also useless)
     * 
     * @param instance The QueryInstance to get the ResultList for.
     * @return A <code>ResultList</code> for QueryInstance.
     */
    ...
    /**
     * This method is used to call the QueryInstance writeResultToTable.
     * Then it will create a SqlResultList over the now cached QueryInstance.
     * This should all really be done in QueryInstance.
     * 
     * @param instance The QueryInstance to cache in the database.
     * @param startRow The start row for the SqlResultList to use.
     * @param endRow The end row for the SqlResultList to use.
     * @return A SqlResultList of the cache table.
     * @throws WdkModelException If a problem occurs reading the database,
     *         a problem occurs writing the log, or the QueryInstance is not Persistent.
     */
    ...
    public void createCache( int numParams, boolean noSchemaOutput )
        ...
        try {
            ...
            logger.info( "Creating sequence " + tblQueryInstanceToUse
                    + "_pkseq" + newline );
    ...
    private ResultSet fetchCachedResult( String resultTableName,
            int sortingIndex ) throws WdkModelException {
